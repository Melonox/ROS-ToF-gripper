...
class PointNet:
    def __init__(self):
        ...
        checkpoint = torch.load('/home/paolo/Documents/gripper_pointnet/log/sem_seg/pointnet2_sem_seg/checkpoints/best_model.pth', weights_only=False) #torch.load(str(experiment_dir) + '/checkpoints/best_model.pth')
